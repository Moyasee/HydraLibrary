import{c as qt,i as b,r as rt,d as ot,g as it,u as yt}from"./index-DklScFds.js";const ut="https://libraryratingsdb.zxcsixx.workers.dev/api/ratings",Pt=5*60*1e3,mt={data:{},lastUpdated:{},get:function(t){const e=this.data[t],s=this.lastUpdated[t];return e&&s&&Date.now()-s<Pt?Promise.resolve(e):null},set:function(t,e){return this.data[t]=e,this.lastUpdated[t]=Date.now(),e},batchGet:function(t){const e={cached:{},uncached:[]};return t.forEach(s=>{const a=this.get(s);a?e.cached[s]=a:e.uncached.push(s)}),e},batchSet:function(t){Object.entries(t).forEach(([e,s])=>{this.set(e,s)})}};function Bt(t){const e=new Date(t),a=Math.floor((new Date-e)/1e3);let n=Math.floor(a/31536e3);return n>=1?n+" year"+(n===1?"":"s")+" ago":(n=Math.floor(a/2592e3),n>=1?n+" month"+(n===1?"":"s")+" ago":(n=Math.floor(a/86400),n>=1?n+" day"+(n===1?"":"s")+" ago":(n=Math.floor(a/3600),n>=1?n+" hour"+(n===1?"":"s")+" ago":(n=Math.floor(a/60),n>=1?n+" minute"+(n===1?"":"s")+" ago":"just now"))))}function V(t){return String(t).replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function Rt(t){let e=localStorage.getItem("hydra_rating_hash");return e||(e=Math.random().toString(36).slice(2)+Date.now(),localStorage.setItem("hydra_rating_hash",e)),e}function Dt(t){document.querySelectorAll(".rating-modal").forEach(d=>d.remove());const e=document.createElement("div");e.className="rating-modal fixed inset-0 z-[9999] flex items-center justify-center p-2 sm:p-4",e.innerHTML=`
  ...
  `,document.body.appendChild(e),document.body.style.overflow="hidden";let s=null;const a=()=>{if(typeof turnstile>"u"){setTimeout(a,100);return}s=turnstile.render("#cf-turnstile-container",{sitekey:"0x4AAAAAABgPUEsL6w8fjG-Z",theme:"dark",callback:function(d){const c=document.querySelector('#submit-rating-form button[type="submit"]');c&&(c.disabled=!1)},"expired-callback":function(){const d=document.querySelector('#submit-rating-form button[type="submit"]');d&&(d.disabled=!0)},"error-callback":function(){const d=document.querySelector('#submit-rating-form button[type="submit"]'),c=document.getElementById("rating-form-error");d&&(d.disabled=!0),c&&(c.textContent="Cloudflare Turnstile verification failed. Please try again.",c.classList.remove("hidden"))}}),console.log("Turnstile initialized")};a(),e.querySelector(".close-rating-modal").onclick=l,e.querySelector(".fixed.inset-0").onclick=d=>{d.target===e.querySelector(".fixed.inset-0")&&l()};async function n(d,c="en"){return new Promise((p,g)=>{const h=JSON.stringify({translate:"rapidapi"}),x=new XMLHttpRequest;x.withCredentials=!0,x.addEventListener("readystatechange",function(){if(this.readyState===this.DONE)try{const y=JSON.parse(this.responseText);if(y&&y.translation)p(y.translation);else throw y&&y.status!==200?new Error(y.business_message||"Translation service error"):new Error("Invalid response from translation service")}catch(y){console.error("Translation error:",y,this.responseText),g(y)}}),x.addEventListener("error",()=>{g(new Error("Network error during translation"))});const P=`https://free-google-translator.p.rapidapi.com/external-api/free-google-translator?from=auto&to=${c}&query=${encodeURIComponent(d)}`;x.open("POST",P),x.setRequestHeader("x-rapidapi-key",""),x.setRequestHeader("x-rapidapi-host","free-google-translator.p.rapidapi.com"),x.setRequestHeader("Content-Type","application/json"),x.send(h)})}async function i(d){const c=d.target.closest(".translate-comment");if(!c||c.disabled)return;d.preventDefault(),d.stopPropagation();const p=c.closest(".border-b"),g=p?p.querySelector(".comment-text p"):null;if(!g){console.error("Could not find comment text element");return}let h=c.getAttribute("data-original");if(c.classList.contains("active")){h&&(g.textContent=h,c.innerHTML='<i class="fas fa-language text-xs"></i><span class="hidden sm:inline">Translate</span>',c.classList.remove("active"),c.title="Translate this review"),c.disabled=!1;return}h=g.textContent.trim(),c.setAttribute("data-original",h),c.innerHTML,c.innerHTML='<i class="fas fa-spinner fa-spin text-xs"></i>',c.title="Translating...",c.disabled=!0;try{const x=await n(h,"en");g.textContent=x,c.innerHTML='<i class="fas fa-undo text-xs"></i><span class="hidden sm:inline">Original</span>',c.classList.add("active"),c.title="Show original text"}catch(x){console.error("Translation failed:",x),g.textContent=h,c.innerHTML='<i class="fas fa-exclamation-triangle text-xs"></i><span class="hidden sm:inline">Error</span>',c.title="Error translating. Click to try again."}finally{c.disabled=!1}}const o=e.querySelector("#rating-comments-list");o&&o.addEventListener("click",i);const r=e.querySelector('textarea[name="comment"]'),u=e.querySelector(".char-count");if(r&&u){const d=()=>{u.textContent=r.value.length};r.addEventListener("input",d),d(),e._cleanupCharCounter=()=>{r.removeEventListener("input",d)}}function l(){e._cleanupCharCounter&&e._cleanupCharCounter(),e.remove(),document.body.style.overflow=""}const f=5*60*1e3;let m=1,w="recent",S=0,E=!1,L=0,T=t.title;function $(){const d=`ratings_${encodeURIComponent(T)}`,c=localStorage.getItem(d);if(!c)return null;try{const{data:p,timestamp:g}=JSON.parse(c);if(Date.now()-g<f)return p}catch(p){console.warn("Error reading cache:",p)}return null}function M(d){try{const c=`ratings_${encodeURIComponent(T)}`,p={data:d,timestamp:Date.now()};localStorage.setItem(c,JSON.stringify(p))}catch(c){console.warn("Error saving to cache:",c)}}async function C(d=1,c=!1){if(E)return;const p=e.querySelector("#rating-comments-list");if(!p)return;p.innerHTML='<div class="flex justify-center items-center py-6"><div class="animate-spin rounded-full h-8 w-8 border-t-2 border-b-2 border-emerald-400"></div></div>';const g=c?null:$();if(g){console.log("Using cached data for:",T),A(g,d),Date.now()-L>f&&B(!0);return}await B()}function A(d,c=1){const p=e.querySelector("#rating-comments-list");if(p){if(p.innerHTML="",d.avg!==void 0){const g=parseFloat(d.avg).toFixed(1),h=parseInt(d.total)||0,x=e.querySelector("#rating-modal-stars"),P=e.querySelector("#rating-modal-avg"),y=e.querySelector("#rating-modal-total");if(x){x.innerHTML="";const F=Math.round(parseFloat(d.avg));x.innerHTML="★".repeat(F)+"☆".repeat(5-F)}P&&(P.textContent=`${g} out of 5`),y&&(y.textContent=`${h} ${h===1?"review":"reviews"}`)}if(!d.comments||d.comments.length===0){p.innerHTML=`
      ...
      `;return}M(d),d.pagination&&(S=d.pagination.total||0,G()),d.comments.forEach(g=>{if(!g)return;const h=document.createElement("div");h.className="border-b border-gray-700 py-4";const x=g.timestamp?new Date(g.timestamp).getTime():Date.now();h.innerHTML=`
        <div class="flex items-start justify-between mb-2">
          ...
          <span class="text-xs text-gray-500">${Bt(x)}</span>
        </div>
    ...
    `;d.innerHTML=p}window.loadPage=d=>{if(!k||!k.comments)return;const c=Math.ceil(k.comments.length/10);d<1||d>c||(m=d,R())},e._vm={loadPage:window.loadPage};async function B(d=!1){var x,P;if(E)return;E=!0;const c=e.querySelector("#rating-comments-list");!d&&c&&(c.innerHTML='<div class="text-center py-4 text-gray-400">Loading comments...</div>');const p=`comments_${T}`,g=5*60*1e3,h=mt.get(p);if(h&&Date.now()-h.timestamp<g){k=h,R(),E=!1;return}try{const y=await fetch(`${ut}?source=${encodeURIComponent(T)}&all=true`);if(!y.ok)throw new Error(`Failed to fetch comments: ${y.statusText}`);const F=await y.json();k={...F,comments:F.comments||[],pagination:{total:((x=F.comments)==null?void 0:x.length)||0,page:1,totalPages:1,perPage:((P=F.comments)==null?void 0:P.length)||0}},mt.set(p,{...k,timestamp:Date.now()}),L=Date.now(),R()}catch(y){console.error("Error fetching comments:",y),h?(k=h,R()):!d&&c&&(c.innerHTML=`
          <div class="text-red-500 text-center py-4">
            Failed to load comments. Please try again later.
            ${y.message?`<div class="text-xs mt-1">${y.message}</div>`:""}
          </div>
        `)}finally{E=!1}}function R(){if(!k||!k.comments)return;const d=J([...k.comments],w),c=10,p=Math.ceil(d.length/c),g=(m-1)*c,h=d.slice(g,g+c);k.pagination={total:d.length,page:m,totalPages:p,perPage:c},A({...k,comments:h,pagination:k.pagination},m)}let k=null;function J(d,c){if(!d)return[];const p=[...d];switch(c){case"recent":return p.sort((g,h)=>{const x=g.timestamp?new Date(g.timestamp).getTime():0;return(h.timestamp?new Date(h.timestamp).getTime():0)-x});case"high":return p.sort((g,h)=>(h.rating||0)-(g.rating||0));case"low":return p.sort((g,h)=>(g.rating||0)-(h.rating||0));default:return p}}function At(){const d=e.querySelector("#rating-sort-select");d&&d.addEventListener("change",c=>{w=c.target.value,m=1,R()})}At(),C(),C();const W=e.querySelector("#submit-rating-form"),O=e.querySelector("#rating-form-error"),j=W.querySelector('button[type="submit"]');j.disabled=!0,W.onsubmit=async d=>{var c;d.preventDefault(),O.textContent="",O.className="text-sm text-rose-400 mt-2";try{const p=new FormData(W),g=(p.get("nickname")||"").trim(),h=p.get("rating"),x=(p.get("comment")||"").trim();if(!g)throw new Error("Please enter a nickname");if(!h||isNaN(h)||h<1||h>5)throw new Error("Please select a valid rating between 1 and 5");if(!x||x.split(/\s+/).length<3)throw new Error("Please enter a message with at least 3 words");const P=(c=document.querySelector('input[name="cf-turnstile-response"]'))==null?void 0:c.value;if(!P)throw new Error("Please complete the Cloudflare Turnstile verification");const y=await Rt(),F=`hydra_rating_${T}_${y}`;j.disabled=!0,j.innerHTML='<i class="fas fa-spinner fa-spin mr-2"></i> Submitting...',O.classList.add("hidden");const $t={source:T,nickname:g,rating:Number(h),message:x,ipHash:y,turnstileToken:P},dt=await fetch(ut,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify($t)}),Mt=await dt.json();if(!dt.ok)throw new Error(Mt.error||"Failed to submit rating");showNotification("Rating submitted successfully! It will be visible after moderation.","success"),setTimeout(l,1500),W.reset(),window.turnstile&&s!==null&&window.turnstile.reset(s)}catch(p){console.error("Error submitting rating:",p),O.textContent=p.message||"Failed to submit rating. Please try again.",O.classList.remove("hidden"),window.turnstile&&s!==null&&window.turnstile.reset(s)}finally{j&&(j.disabled=!1,j.innerHTML='<i class="fas fa-paper-plane mr-2"></i> Submit Review')}}}document.body.classList.add("preloading");document.addEventListener("DOMContentLoaded",async()=>{await qt.initialize()});function Ft(){const t=document.getElementById("preloader"),e=t.querySelector(".loading-progress"),s=t.querySelector(".loading-percentage");let a=0;const n=()=>{const i=100-a,o=Math.min(i*.1,Math.max(.2,Math.random()*.8));a=Math.min(100,a+o),e.style.width=`${a}%`;const r=a<100?a.toFixed(1):Math.round(a);s.textContent=`${r}%`,a<30?s.className="loading-percentage text-sm font-medium text-white/70":a<60?s.className="loading-percentage text-sm font-medium text-emerald-400/70":s.className="loading-percentage text-sm font-medium text-emerald-400",a<100?requestAnimationFrame(n):setTimeout(()=>{t.classList.add("hiding"),t.addEventListener("transitionend",()=>{t.remove(),document.body.classList.remove("preloading"),b.updatePageContent(),et()},{once:!0})},1e3)};setTimeout(()=>{t&&document.body.contains(t)&&(console.log("Preloader safety timeout triggered"),t.classList.add("hiding"),setTimeout(()=>{t.remove(),document.body.classList.remove("preloading"),b.updatePageContent(),et()},400))},5e3),setTimeout(()=>{requestAnimationFrame(n)},300)}function et(){const t=document.getElementById("language-switcher"),e=document.getElementById("language-dropdown");if(!t||!e)return;const s=t.cloneNode(!0);t.parentNode.replaceChild(s,t);const a=b.getCurrentLocale(),n=s.querySelector("span");if(n){const r={en:"English",ru:"Русский","pt-br":"Português"};n.textContent=r[a]||"English"}s.addEventListener("click",r=>{r.preventDefault(),r.stopPropagation(),e.classList.contains("hidden")?(e.classList.remove("hidden"),s.classList.add("bg-white/10")):(e.classList.add("hidden"),s.classList.remove("bg-white/10"))}),e.querySelectorAll("button").forEach(r=>{r.addEventListener("click",u=>{u.preventDefault(),u.stopPropagation();const l=r.dataset.lang;if(b.setLocale(l),e.classList.add("hidden"),s.classList.remove("bg-white/10"),n){const f={en:"English",ru:"Русский","pt-br":"Português"};n.textContent=f[l]||"English"}q()})}),document.addEventListener("click",r=>{s.contains(r.target)||(e.classList.add("hidden"),s.classList.remove("bg-white/10"))});const o=()=>{const r=t.querySelector("span"),u={en:"English",ru:"Русский","pt-br":"Português"};r.textContent=u[b.currentLocale]||"English"};document.addEventListener("languageChanged",o)}document.addEventListener("DOMContentLoaded",()=>{try{Ft()}catch(i){console.error("Error initializing preloader:",i);const o=document.getElementById("preloader");o&&o.remove(),document.body.classList.remove("preloading"),b.updatePageContent(),et()}Qt();const t=document.getElementById("accept-cookies"),e=document.getElementById("reject-cookies"),s=document.getElementById("cookie-consent");t&&t.addEventListener("click",()=>{a(),tt("cookie-consent","accepted",365)}),e&&e.addEventListener("click",()=>{a(),tt("cookie-consent","rejected",365)});function a(){s.classList.add("translate-y-full"),s.addEventListener("transitionend",()=>{s.style.display="none"},{once:!0})}bt(),setTimeout(()=>{Et()},300),te(),ee(),se(),st(),Ut(),initializeMobileFilters();let n;window.addEventListener("resize",()=>{clearTimeout(n),n=setTimeout(()=>{st()},100)})});function bt(){try{console.log("Initializing sorting..."),document.querySelectorAll(".sort-option").forEach(e=>{e.addEventListener("click",s=>{s.preventDefault(),s.stopPropagation();const a=e.getAttribute("data-sort");if(console.log("Sort option clicked:",a),a){at(a);const n=document.getElementById("mobile-filters");n&&!n.classList.contains("hidden")&&(n.classList.add("hidden"),document.body.style.overflow="auto"),q()}})});const t=localStorage.getItem("currentSort")||"hot";console.log("Initial sort type:",t),at(t),console.log("Sorting initialized with type:",t)}catch(t){console.error("Error initializing sorting:",t)}}let v=[],N="",D=null,I=1;const U={mobile:4,tablet:6,desktop:9,wide:15},H=document.getElementById("about-modal"),Ht=document.getElementById("about-btn"),wt=document.getElementById("close-about"),_=document.getElementById("suggest-modal"),Nt=document.getElementById("suggest-btn"),_t=document.getElementById("close-suggest"),Z=24*60*60*1e3;document.getElementById("mobile-filters-btn");document.getElementById("mobile-filters-modal");document.getElementById("close-mobile-filters");document.getElementById("mobile-filters-content");document.getElementById("reset-filters");document.getElementById("apply-filters");const Y=document.getElementById("active-filters-count"),jt={tablet:768};function st(){var a;const t=document.getElementById("filters-sidebar"),e=(a=document.getElementById("mobile-filters-btn"))==null?void 0:a.parentElement;if(!t||!e)return;const s=window.innerWidth<jt.tablet;t.classList.toggle("hidden",s),e.classList.toggle("hidden",!s)}function Ut(){const t=document.getElementById("mobile-filters-btn"),e=document.getElementById("mobile-filters-modal"),s=e==null?void 0:e.querySelector(".flex.flex-col.bg-\\[\\#111\\]"),a=e==null?void 0:e.querySelector(".bg-\\[\\#0A0A0A\\]");if(!t||!e||!s||!a)return;function n(){e.classList.remove("hidden"),e.offsetHeight,a.classList.add("opacity-100"),s.classList.remove("translate-y-full"),document.body.classList.add("overflow-hidden")}function i(){a.classList.remove("opacity-100"),s.classList.add("translate-y-full"),setTimeout(()=>{e.classList.add("hidden"),document.body.classList.remove("overflow-hidden")},300)}t.addEventListener("click",l=>{l.preventDefault(),n()});const o=document.getElementById("close-mobile-filters");o&&o.addEventListener("click",l=>{l.preventDefault(),i()}),e.addEventListener("click",l=>{l.target===e&&i()}),document.addEventListener("keydown",l=>{l.key==="Escape"&&!e.classList.contains("hidden")&&i()});const r=document.getElementById("reset-filters");r&&r.addEventListener("click",l=>{l.preventDefault(),zt(),St()});const u=document.getElementById("apply-filters");u&&u.addEventListener("click",l=>{l.preventDefault(),i(),q()})}function St(){const t=Ot();Y&&(t>0?(Y.textContent=`${t} active`,Y.classList.remove("hidden")):Y.classList.add("hidden"))}function Ot(){let t=0;return N&&t++,D&&t++,localStorage.getItem("currentSort")&&t++,t}function zt(){N="",D=null,localStorage.removeItem("currentSort"),document.querySelectorAll(".status-filter-btn div").forEach(t=>{t.classList.remove("bg-black/40")}),document.querySelectorAll(".games-filter-btn div").forEach(t=>{t.classList.remove("border-emerald-500/20","bg-black/40"),t.classList.add("border-white/5","bg-black/20")}),document.querySelectorAll(".sort-option").forEach(t=>{t.classList.remove("bg-white/10","text-white"),t.classList.add("text-white/70")}),q()}async function Et(){try{v=(await(await fetch("data/resources.json")).json()).sources;const s="hydra_ratings_cache",a=5*60*1e3,n=()=>{try{const r=localStorage.getItem(s);if(!r)return null;const{timestamp:u,data:l}=JSON.parse(r);if(Date.now()-u<a)return l}catch(r){console.error("Error reading from cache:",r)}return null},i=r=>{try{localStorage.setItem(s,JSON.stringify({timestamp:Date.now(),data:r}))}catch(u){console.error("Error saving to cache:",u)}},o=n();if(o){console.log("Using cached ratings data"),v.forEach(r=>{const u=o[r.title]||{avg:0,total:0};r.rating={avg:parseFloat(u.avg)||0,total:parseInt(u.total)||0}});return}console.log("Fetching fresh ratings data...");try{const r=[...new Set(v.map(m=>m.title))];console.log(`Fetching ratings for ${r.length} sources`);const u=`https://libraryratingsdb.zxcsixx.workers.dev/api/ratings?batch=true&sources=${r.map(encodeURIComponent).join(",")}`;console.log("Batch API URL:",u);const l=await fetch(u);if(console.log("Batch response status:",l.status),!l.ok)throw new Error(`HTTP error! status: ${l.status}`);const f=await l.json();console.log("Received batch ratings data"),i(f),v.forEach(m=>{const w=f[m.title]||{avg:0,total:0};m.rating={avg:parseFloat(w.avg)||0,total:parseInt(w.total)||0}}),console.log("All ratings loaded via batch endpoint")}catch(r){console.error("Error in batch ratings fetch:",r),v.forEach(u=>{u.rating={avg:0,total:0}})}bt(),q(),Gt()}catch(t){console.error("Error loading sources:",t);const e=document.getElementById("sources-container");e&&(e.innerHTML=`
                ...
                <div class="mt-2 pt-2 text-white/40 relative">
                    ...
                    <div class="flex items-center justify-between">
                        <span class="hidden lg:flex items-center gap-1.5 text-white/40 text-[10px] sm:text-xs">
                            ...
                            <span class="whitespace-nowrap">${Zt(t.addedDate)}</span>
                        </span>
    ...
    `;const l=(T=r.querySelector("[data-rating-stars-container]"))==null?void 0:T.parentElement;l&&(l.addEventListener("click",$=>{$.stopPropagation(),Dt(t)}),Tt(r,t.rating));const f=r.querySelector(".install-btn"),m=r.querySelector(".copy-btn");return m&&m.addEventListener("click",async()=>{const $=async()=>{await vt(t.url,"copy")&&(navigator.clipboard.writeText(t.url),m.innerHTML='<i class="fas fa-check text-[10px]"></i> '+b.t("sourceCard.copied"),setTimeout(()=>{m.innerHTML='<i class="fas fa-copy text-[10px]"></i> '+b.t("sourceCard.copy")},2e3))},M=t.title==="CPGRepacks";n||M?(M?ft:gt)(A=>{A&&$()}):$()}),f&&f.addEventListener("click",async()=>{const $=async()=>{xt(f,"loading");const C=await vt(t.url,"install");if(xt(f,C?"success":"rate-limited"),C){const A=encodeURIComponent(t.url);window.location.href=`hydralauncher://install-source?urls=${A}`}},M=t.title==="CPGRepacks";t.status.includes("Use At Your Own Risk")||M?(M?ft:gt)(A=>{A&&$()}):$()}),ct(t.url,t.stats),r.dataset.copies=i.copies||0,r.dataset.installs=i.installs||0,r.dataset.activity=o,r}let K="wide";function Lt(){const t=window.innerWidth;return t>=1536?"wide":t>=1024?"desktop":t>=640?"tablet":"mobile"}let pt;window.addEventListener("resize",()=>{clearTimeout(pt),pt=setTimeout(()=>{st();const t=Lt();if(K!==t){const s=lt(),a=Q(),n=Math.ceil(s.length/a);if(K==="wide"&&t==="desktop"){const i=(I-1)*U.desktop;I=Math.floor(i/U.desktop)+1}K=t,I=Math.min(Math.max(1,I),n),q(s),a<Q()&&window.scrollTo({top:0,behavior:"smooth"})}},100)});function ht(t,e){return console.log(`Sorting sources by: ${e}`),[...t].sort((s,a)=>{var n,i,o,r,u,l,f,m,w,S,E,L;try{switch(e){case"hot":const T=((n=s.stats)==null?void 0:n.recentActivity)||0;return(((i=a.stats)==null?void 0:i.recentActivity)||0)-T;case"new":return new Date(a.addedDate||0)-new Date(s.addedDate||0);case"most-copies":const M=((o=s.stats)==null?void 0:o.copies)||0;return(((r=a.stats)==null?void 0:r.copies)||0)-M;case"most-installs":const A=((u=s.stats)==null?void 0:u.installs)||0;return(((l=a.stats)==null?void 0:l.installs)||0)-A;case"top-rated":console.log(`Comparing ratings: ${s.title} (${((f=s.rating)==null?void 0:f.avg)||0}) vs ${a.title} (${((m=a.rating)==null?void 0:m.avg)||0})`),console.log(`Full rating data for ${s.title}:`,s.rating),console.log(`Full rating data for ${a.title}:`,a.rating);const B=((w=s.rating)==null?void 0:w.avg)||0,R=((S=a.rating)==null?void 0:S.avg)||0;if(B===R){const k=((E=s.rating)==null?void 0:E.total)||0,J=((L=a.rating)==null?void 0:L.total)||0;return console.log(`Ratings equal (${B}), comparing counts: ${k} vs ${J}`),J-k}return console.log(`Sorting by rating: ${R} - ${B} = ${R-B}`),R-B;case"name-asc":return(s.title||"").localeCompare(a.title||"");case"name-desc":return(a.title||"").localeCompare(s.title||"");default:return 0}}catch(T){return console.error("Error in sort function:",T),console.error("Sort type:",e),console.error("Source A:",s),console.error("Source B:",a),0}})}function at(t){var e;try{console.log("Updating active sort UI for:",t);const s=document.querySelector(".mobile-sort-button span");if(s){const n=((e=document.querySelector(`.sort-option[data-sort="${t}"]`))==null?void 0:e.textContent)||"Sort";s.textContent=n}document.querySelectorAll(".sort-option").forEach(n=>{const i=n.getAttribute("data-sort")===t;n.classList.toggle("bg-white/10",i),n.classList.toggle("text-white",i),n.classList.toggle("text-white/70",!i);const o=n.querySelector("i.fa-check");o&&(o.style.opacity=i?"1":"0")});const a=document.getElementById("sort-dropdown");a&&!a.classList.contains("hidden")&&a.classList.add("hidden"),localStorage.setItem("currentSort",t)}catch(s){console.error("Error updating sort UI:",s)}}function q(t=null){const e=document.getElementById("sources-container");if(e){e.innerHTML="";try{let s=t||lt();console.log(`Displaying ${s.length} filtered sources`);const a=localStorage.getItem("currentSort")||"hot";if(console.log("Current sort type:",a),a){console.log("Before sorting - first few sources:",s.slice(0,3).map(l=>{var f,m;return{title:l.title,rating:l.rating,hasRating:!!((f=l.rating)!=null&&f.avg||(m=l.rating)!=null&&m.total)}}));try{s=ht(s,a),console.log("After sorting - first few sources:",s.slice(0,3).map(l=>{var f,m;return{title:l.title,rating:l.rating,sortKey:a==="top-rated"?`${((f=l.rating)==null?void 0:f.avg)||0} (${((m=l.rating)==null?void 0:m.total)||0} ratings)`:l[a]||"N/A"}})),at(a)}catch(l){console.error("Error during sorting:",l),s=ht(s,"hot")}}K=Lt();const n=Q(),i=Math.ceil(s.length/n);I=Math.min(Math.max(1,I),i);const o=(I-1)*n,r=Math.min(o+n,s.length);s.slice(o,r).forEach(l=>{const f=Jt(l);e.appendChild(f)}),Wt(i),b.updatePageContent()}catch(s){console.error("Error in displaySources:",s),e.innerHTML=`
        ...
        `}}}function Q(){const t=window.innerWidth;return t>=2560?U.wide:t>=1024?U.desktop:t>=640?U.tablet:U.mobile}function Wt(t){const e=document.getElementById("pagination");if(!e)return;let s="";s+=`
