import{i as w}from"./index-DJTFg3TM.js";import{c as _e,r as oe,d as ie,g as le,u as Ee}from"./firebase-connection-D9-JVH6U.js";import{c as je}from"./changelog-notification-DPn7bzXV.js";const fe="https://libraryratingsdb.zxcsixx.workers.dev/api/ratings",Ue=5*60*1e3,pe={data:{},lastUpdated:{},get:function(e){const t=this.data[e],n=this.lastUpdated[e];return t&&n&&Date.now()-n<Ue?Promise.resolve(t):null},set:function(e,t){return this.data[e]=t,this.lastUpdated[e]=Date.now(),t},batchGet:function(e){const t={cached:{},uncached:[]};return e.forEach(n=>{const s=this.get(n);s?t.cached[n]=s:t.uncached.push(n)}),t},batchSet:function(e){Object.entries(e).forEach(([t,n])=>{this.set(t,n)})}};function Oe(e){const t=new Date(e),s=Math.floor((new Date-t)/1e3);let a=Math.floor(s/31536e3);return a>=1?a+" year"+(a===1?"":"s")+" ago":(a=Math.floor(s/2592e3),a>=1?a+" month"+(a===1?"":"s")+" ago":(a=Math.floor(s/86400),a>=1?a+" day"+(a===1?"":"s")+" ago":(a=Math.floor(s/3600),a>=1?a+" hour"+(a===1?"":"s")+" ago":(a=Math.floor(s/60),a>=1?a+" minute"+(a===1?"":"s")+" ago":"just now"))))}function W(e){return String(e).replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}async function ze(){var e;try{const n=[navigator.userAgent,navigator.language,screen.width,screen.height,navigator.platform,new Date().getTimezoneOffset(),!!navigator.cookieEnabled,navigator.hardwareConcurrency||0,navigator.deviceMemory||0,screen.colorDepth,((e=window.screen.orientation)==null?void 0:e.type)||""].join("|"),s=new TextEncoder().encode(n),a=await crypto.subtle.digest("SHA-256",s),o=Array.from(new Uint8Array(a)).map(r=>r.toString(16).padStart(2,"0")).join("");return sessionStorage.setItem("hydra_rating_hash",o),localStorage.getItem("hydra_rating_hash")||localStorage.setItem("hydra_rating_hash",o),o}catch(t){return console.error("Error generating user hash:",t),Math.random().toString(36).slice(2)+Date.now().toString(36)}}function Ge(e){const n=`rating_submission_${e}`,s=localStorage.getItem(n);if(!s)return!0;const a=parseInt(s,10),i=Date.now(),o=60*60*1e3;return i-a>o}function Je(e){const t=`rating_submission_${e}`;localStorage.setItem(t,Date.now().toString())}function Ve(e){document.querySelectorAll(".rating-modal").forEach(l=>l.remove());const t=document.createElement("div");t.className="rating-modal fixed inset-0 z-[9999] flex items-center justify-center p-2 sm:p-4",t.innerHTML=`
  ...
  `;const s=document.querySelector(".rating-modal");s?s.appendChild(n):document.body.appendChild(n),setTimeout(()=>{n.remove()},15e3)}console.log("Changelog notification system loaded:",je);document.body.classList.add("preloading");document.addEventListener("DOMContentLoaded",async()=>{await _e.initialize()});function We(){const e=document.getElementById("preloader"),t=e.querySelector(".loading-progress"),n=e.querySelector(".loading-percentage");let s=0;const a=()=>{const i=100-s,o=Math.min(i*.1,Math.max(.2,Math.random()*.8));s=Math.min(100,s+o),t.style.width=`${s}%`;const r=s<100?s.toFixed(1):Math.round(s);n.textContent=`${r}%`,s<30?n.className="loading-percentage text-sm font-medium text-white/70":s<60?n.className="loading-percentage text-sm font-medium text-emerald-400/70":n.className="loading-percentage text-sm font-medium text-emerald-400",s<100?requestAnimationFrame(a):setTimeout(()=>{e.classList.add("hiding"),e.addEventListener("transitionend",()=>{e.remove(),document.body.classList.remove("preloading"),w.updatePageContent(),ne()},{once:!0})},1e3)};w.updatePageContent(),ne(),setTimeout(()=>{e&&document.body.contains(e)&&(console.log("Preloader safety timeout triggered"),e.classList.add("hiding"),setTimeout(()=>{e.remove(),document.body.classList.remove("preloading")},400))},4e3),setTimeout(()=>{requestAnimationFrame(a)},300)}function ne(){const e=document.getElementById("language-switcher"),t=document.getElementById("language-dropdown");if(!e||!t)return;const n=e.cloneNode(!0);e.parentNode.replaceChild(n,e);const s=w.getCurrentLocale(),a=n.querySelector("span");if(a){const r={en:"English",ru:"Русский","pt-br":"Português"};a.textContent=r[s]||"English"}n.addEventListener("click",r=>{r.preventDefault(),r.stopPropagation(),t.classList.contains("hidden")?(t.classList.remove("hidden"),n.classList.add("bg-white/10")):(t.classList.add("hidden"),n.classList.remove("bg-white/10"))}),t.querySelectorAll("button").forEach(r=>{r.addEventListener("click",d=>{d.preventDefault(),d.stopPropagation();const c=r.dataset.lang;if(w.setLocale(c),t.classList.add("hidden"),n.classList.remove("bg-white/10"),a){const p={en:"English",ru:"Русский","pt-br":"Português"};a.textContent=p[c]||"English"}B(),he(c)})}),document.addEventListener("click",r=>{n.contains(r.target)||(t.classList.add("hidden"),n.classList.remove("bg-white/10"))});const o=()=>{const r=e.querySelector("span"),d={en:"English",ru:"Русский","pt-br":"Português"};r.textContent=d[w.currentLocale]||"English"};document.addEventListener("languageChanged",o),he(w.currentLocale)}function he(e){const t=document.getElementById("vpn-banner");t&&(e==="ru"?t.classList.remove("hidden"):t.classList.add("hidden"))}document.addEventListener("DOMContentLoaded",()=>{try{We()}catch(i){console.error("Error initializing preloader:",i);const o=document.getElementById("preloader");o&&o.remove(),document.body.classList.remove("preloading"),w.updatePageContent(),ne()}dt();const e=document.getElementById("accept-cookies"),t=document.getElementById("reject-cookies"),n=document.getElementById("cookie-consent");e&&e.addEventListener("click",()=>{s(),te("cookie-consent","accepted",365)}),t&&t.addEventListener("click",()=>{s(),te("cookie-consent","rejected",365)});function s(){n.classList.add("translate-y-full"),n.addEventListener("transitionend",()=>{n.style.display="none"},{once:!0})}Le(),$e(),setTimeout(()=>{Ie()},300),mt(),gt(),ft(),se(),et(),initializeMobileFilters();let a;window.addEventListener("resize",()=>{clearTimeout(a),a=setTimeout(()=>{se()},100)})});function Le(){try{console.log("Initializing sorting..."),document.querySelectorAll(".sort-option").forEach(t=>{t.addEventListener("click",n=>{n.preventDefault(),n.stopPropagation();const s=t.getAttribute("data-sort");if(console.log("Sort option clicked:",s),s){ae(s);const a=document.getElementById("mobile-filters");a&&!a.classList.contains("hidden")&&(a.classList.add("hidden"),document.body.style.overflow="auto"),B()}})});const e=localStorage.getItem("currentSort")||"hot";console.log("Initial sort type:",e),ae(e),console.log("Sorting initialized with type:",e)}catch(e){console.error("Error initializing sorting:",e)}}let y=[],N="",R=null,T=1;const O={mobile:4,tablet:6,desktop:9,wide:15},F=document.getElementById("about-modal"),Ke=document.getElementById("about-btn"),Ce=document.getElementById("close-about"),_=document.getElementById("suggest-modal"),Ze=document.getElementById("suggest-btn"),Qe=document.getElementById("close-suggest"),Q=24*60*60*1e3;document.getElementById("mobile-filters-btn");document.getElementById("mobile-filters-modal");document.getElementById("close-mobile-filters");document.getElementById("mobile-filters-content");document.getElementById("reset-filters");document.getElementById("apply-filters");const K=document.getElementById("active-filters-count"),Xe={tablet:768};function se(){var s;const e=document.getElementById("filters-sidebar"),t=(s=document.getElementById("mobile-filters-btn"))==null?void 0:s.parentElement;if(!e||!t)return;const n=window.innerWidth<Xe.tablet;e.classList.toggle("hidden",n),t.classList.toggle("hidden",!n)}function et(){const e=document.getElementById("mobile-filters-btn"),t=document.getElementById("mobile-filters-modal"),n=t==null?void 0:t.querySelector(".flex.flex-col.bg-\\[\\#111\\]"),s=t==null?void 0:t.querySelector(".bg-\\[\\#0A0A0A\\]");if(!e||!t||!n||!s)return;function a(){t.classList.remove("hidden"),t.offsetHeight,s.classList.add("opacity-100"),n.classList.remove("translate-y-full"),document.body.classList.add("overflow-hidden")}function i(){s.classList.remove("opacity-100"),n.classList.add("translate-y-full"),setTimeout(()=>{t.classList.add("hidden"),document.body.classList.remove("overflow-hidden")},300)}e.addEventListener("click",c=>{c.preventDefault(),a()});const o=document.getElementById("close-mobile-filters");o&&o.addEventListener("click",c=>{c.preventDefault(),i()}),t.addEventListener("click",c=>{c.target===t&&i()}),document.addEventListener("keydown",c=>{c.key==="Escape"&&!t.classList.contains("hidden")&&i()});const r=document.getElementById("reset-filters");r&&r.addEventListener("click",c=>{c.preventDefault(),nt(),ke()});const d=document.getElementById("apply-filters");d&&d.addEventListener("click",c=>{c.preventDefault(),i(),B()})}function ke(){const e=tt();K&&(e>0?(K.textContent=`${e} active`,K.classList.remove("hidden")):K.classList.add("hidden"))}function tt(){let e=0;return N&&e++,R&&e++,localStorage.getItem("currentSort")&&e++,e}function nt(){N="",R=null,localStorage.removeItem("currentSort"),document.querySelectorAll(".status-filter-btn div").forEach(e=>{e.classList.remove("bg-black/40")}),document.querySelectorAll(".games-filter-btn div").forEach(e=>{e.classList.remove("border-emerald-500/20","bg-black/40"),e.classList.add("border-white/5","bg-black/20")}),document.querySelectorAll(".sort-option").forEach(e=>{e.classList.remove("bg-white/10","text-white"),e.classList.add("text-white/70")}),B()}async function Ie(){try{y=(await(await fetch("data/resources.json")).json()).sources;const n="hydra_ratings_cache",s=5*60*1e3,a=()=>{try{const r=localStorage.getItem(n);if(!r)return null;const{timestamp:d,data:c}=JSON.parse(r);if(Date.now()-d<s)return c}catch(r){console.error("Error reading from cache:",r)}return null},i=r=>{try{localStorage.setItem(n,JSON.stringify({timestamp:Date.now(),data:r}))}catch(d){console.error("Error saving to cache:",d)}},o=a();if(o)console.log("Using cached ratings data"),y.forEach(r=>{const d=o[r.title]||{avg:0,total:0};r.rating={avg:parseFloat(d.avg)||0,total:parseInt(d.total)||0}});else{console.log("Fetching fresh ratings data...");try{const r=[...new Set(y.map(h=>h.title))];console.log(`Fetching ratings for ${r.length} sources`);const d=`https://libraryratingsdb.zxcsixx.workers.dev/api/ratings?batch=true&sources=${r.map(encodeURIComponent).join(",")}`;console.log("Batch API URL:",d);const c=await fetch(d);if(console.log("Batch response status:",c.status),!c.ok)throw new Error(`HTTP error! status: ${c.status}`);const p=await c.json();console.log("Received batch ratings data"),i(p),y.forEach(h=>{const E=p[h.title]||{avg:0,total:0};h.rating={avg:parseFloat(E.avg)||0,total:parseInt(E.total)||0}}),console.log("All ratings loaded via batch endpoint")}catch(r){console.error("Error in batch ratings fetch:",r),y.forEach(d=>{d.rating={avg:0,total:0}})}}Le(),ce(),B();try{await st()}finally{setTimeout(()=>{const r=document.getElementById("preloader");r&&(r.style.opacity="0",setTimeout(()=>{r.style.display="none",B()},300))},500)}}catch(e){console.error("Error loading sources:",e);const t=document.getElementById("sources-container");t&&(t.innerHTML=`
    ...
    `;const c=(q=r.querySelector("[data-rating-stars-container]"))==null?void 0:q.parentElement;c&&(c.addEventListener("click",$=>{$.stopPropagation(),Ve(e)}),qe(r,e.rating));const p=r.querySelector(".install-btn"),h=r.querySelector(".copy-btn");return h&&h.addEventListener("click",async()=>{const $=async()=>{await we(e.url,"copy")&&(navigator.clipboard.writeText(e.url),h.innerHTML='<i class="fas fa-check text-[10px]"></i> '+w.t("sourceCard.copied"),setTimeout(()=>{h.innerHTML='<i class="fas fa-copy text-[10px]"></i> '+w.t("sourceCard.copy")},2e3))},S=e.title==="CPGRepacks";a||S?(S?ve:ye)(P=>{P&&$()}):$()}),p&&p.addEventListener("click",async()=>{const $=async()=>{Se(p,"loading");const I=await we(e.url,"install");if(Se(p,I?"success":"rate-limited"),I){const P=encodeURIComponent(e.url);window.location.href=`hydralauncher://install-source?urls=${P}`}},S=e.title==="CPGRepacks";e.status.includes("Use At Your Own Risk")||S?(S?ve:ye)(P=>{P&&$()}):$()}),ue(e.url,e.stats),r.dataset.copies=i.copies||0,r.dataset.installs=i.installs||0,r.dataset.activity=o,r}let Z="wide";function Te(){const e=window.innerWidth;return e>=1536?"wide":e>=1024?"desktop":e>=640?"tablet":"mobile"}let xe;window.addEventListener("resize",()=>{clearTimeout(xe),xe=setTimeout(()=>{se();const e=Te();if(Z!==e){const n=de(),s=X(),a=Math.ceil(n.length/s);if(Z==="wide"&&e==="desktop"){const i=(T-1)*O.desktop;T=Math.floor(i/O.desktop)+1}Z=e,T=Math.min(Math.max(1,T),a),B(n),s<X()&&window.scrollTo({top:0,behavior:"smooth"})}},100)});function be(e,t){return console.log(`Sorting sources by: ${t}`),[...e].sort((n,s)=>{var a,i,o,r,d,c,p,h,E,x,k,C;try{switch(t){case"hot":const q=((a=n.stats)==null?void 0:a.recentActivity)||0;return(((i=s.stats)==null?void 0:i.recentActivity)||0)-q;case"new":return new Date(s.addedDate||0)-new Date(n.addedDate||0);case"most-copies":const S=((o=n.stats)==null?void 0:o.copies)||0;return(((r=s.stats)==null?void 0:r.copies)||0)-S;case"most-installs":const P=((d=n.stats)==null?void 0:d.installs)||0;return(((c=s.stats)==null?void 0:c.installs)||0)-P;case"top-rated":console.log(`Comparing ratings: ${n.title} (${((p=n.rating)==null?void 0:p.avg)||0}) vs ${s.title} (${((h=s.rating)==null?void 0:h.avg)||0})`),console.log(`Full rating data for ${n.title}:`,n.rating),console.log(`Full rating data for ${s.title}:`,s.rating);const D=((E=n.rating)==null?void 0:E.avg)||0,j=((x=s.rating)==null?void 0:x.avg)||0;if(D===j){const G=((k=n.rating)==null?void 0:k.total)||0,H=((C=s.rating)==null?void 0:C.total)||0;return console.log(`Ratings equal (${D}), comparing counts: ${G} vs ${H}`),H-G}return console.log(`Sorting by rating: ${j} - ${D} = ${j-D}`),j-D;case"name-asc":return(n.title||"").localeCompare(s.title||"");case"name-desc":return(s.title||"").localeCompare(n.title||"");default:return 0}}catch(q){return console.error("Error in sort function:",q),console.error("Sort type:",t),console.error("Source A:",n),console.error("Source B:",s),0}})}function ae(e){var t;try{console.log("Updating active sort UI for:",e);const n=document.querySelector(".mobile-sort-button span");if(n){const a=((t=document.querySelector(`.sort-option[data-sort="${e}"]`))==null?void 0:t.textContent)||"Sort";n.textContent=a}document.querySelectorAll(".sort-option").forEach(a=>{const i=a.getAttribute("data-sort")===e;a.classList.toggle("bg-white/10",i),a.classList.toggle("text-white",i),a.classList.toggle("text-white/70",!i);const o=a.querySelector("i.fa-check");o&&(o.style.opacity=i?"1":"0")});const s=document.getElementById("sort-dropdown");s&&!s.classList.contains("hidden")&&s.classList.add("hidden"),localStorage.setItem("currentSort",e)}catch(n){console.error("Error updating sort UI:",n)}}function B(e=null){const t=document.getElementById("sources-container");if(t){t.innerHTML="";try{let n=e||de();console.log(`Displaying ${n.length} filtered sources`);const s=localStorage.getItem("currentSort")||"hot";if(console.log("Current sort type:",s),s){console.log("Before sorting - first few sources:",n.slice(0,3).map(c=>{var p,h;return{title:c.title,rating:c.rating,hasRating:!!((p=c.rating)!=null&&p.avg||(h=c.rating)!=null&&h.total)}}));try{n=be(n,s),console.log("After sorting - first few sources:",n.slice(0,3).map(c=>{var p,h;return{title:c.title,rating:c.rating,sortKey:s==="top-rated"?`${((p=c.rating)==null?void 0:p.avg)||0} (${((h=c.rating)==null?void 0:h.total)||0} ratings)`:c[s]||"N/A"}})),ae(s)}catch(c){console.error("Error during sorting:",c),n=be(n,"hot")}}Z=Te();const a=X(),i=Math.ceil(n.length/a);T=Math.min(Math.max(1,T),i);const o=(T-1)*a,r=Math.min(o+a,n.length);n.slice(o,r).forEach(c=>{const p=at(c);t.appendChild(p)}),rt(i),w.updatePageContent()}catch(n){console.error("Error in displaySources:",n),t.innerHTML=`
            <div class="col-span-full text-center py-10 px-4">
                <div class="text-red-400 text-4xl mb-4">
                    <i class="fas fa-exclamation-triangle"></i>
                </div>
        ...
        `}}}function X(){const e=window.innerWidth;return e>=2560?O.wide:e>=1024?O.desktop:e>=640?O.tablet:O.mobile}function rt(e){const t=document.getElementById("pagination");if(!t)return;let n="";n+=`
