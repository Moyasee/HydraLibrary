import{c as te,i as d,r as H,d as O,g as z,u as J}from"./index-D8AORcGq.js";document.body.classList.add("preloading");document.addEventListener("DOMContentLoaded",async()=>{await te.initialize()});function se(){const e=document.getElementById("preloader"),t=e.querySelector(".loading-progress"),s=e.querySelector(".loading-percentage");let n=0;const a=()=>{const o=100-n,r=Math.min(o*.1,Math.max(.2,Math.random()*.8));n=Math.min(100,n+r),t.style.width=`${n}%`;const i=n<100?n.toFixed(1):Math.round(n);s.textContent=`${i}%`,n<30?s.className="loading-percentage text-sm font-medium text-white/70":n<60?s.className="loading-percentage text-sm font-medium text-emerald-400/70":s.className="loading-percentage text-sm font-medium text-emerald-400",n<100?requestAnimationFrame(a):setTimeout(()=>{e.classList.add("hiding"),e.addEventListener("transitionend",()=>{e.remove(),document.body.classList.remove("preloading"),d.updatePageContent(),F()},{once:!0})},1e3)};setTimeout(()=>{e&&document.body.contains(e)&&(console.log("Preloader safety timeout triggered"),e.classList.add("hiding"),setTimeout(()=>{e.remove(),document.body.classList.remove("preloading"),d.updatePageContent(),F()},400))},5e3),setTimeout(()=>{requestAnimationFrame(a)},300)}function F(){const e=document.getElementById("language-switcher"),t=document.getElementById("language-dropdown");if(!e||!t)return;const s=e.cloneNode(!0);e.parentNode.replaceChild(s,e);const n=d.getCurrentLocale(),a=s.querySelector("span");if(a){const i={en:"English",ru:"Русский","pt-br":"Português"};a.textContent=i[n]||"English"}s.addEventListener("click",i=>{i.preventDefault(),i.stopPropagation(),t.classList.contains("hidden")?(t.classList.remove("hidden"),s.classList.add("bg-white/10")):(t.classList.add("hidden"),s.classList.remove("bg-white/10"))}),t.querySelectorAll("button").forEach(i=>{i.addEventListener("click",l=>{l.preventDefault(),l.stopPropagation();const c=i.dataset.lang;if(d.setLocale(c),t.classList.add("hidden"),s.classList.remove("bg-white/10"),a){const u={en:"English",ru:"Русский","pt-br":"Português"};a.textContent=u[c]||"English"}x()})}),document.addEventListener("click",i=>{s.contains(i.target)||(t.classList.add("hidden"),s.classList.remove("bg-white/10"))});const r=()=>{const i=e.querySelector("span"),l={en:"English",ru:"Русский","pt-br":"Português"};i.textContent=l[d.currentLocale]||"English"};document.addEventListener("languageChanged",r)}document.addEventListener("DOMContentLoaded",()=>{try{se()}catch(o){console.error("Error initializing preloader:",o);const r=document.getElementById("preloader");r&&r.remove(),document.body.classList.remove("preloading"),d.updatePageContent(),F()}be();const e=document.getElementById("accept-cookies"),t=document.getElementById("reject-cookies"),s=document.getElementById("cookie-consent");e&&e.addEventListener("click",()=>{n(),P("cookie-consent","accepted",365)}),t&&t.addEventListener("click",()=>{n(),P("cookie-consent","rejected",365)});function n(){s.classList.add("translate-y-full"),s.addEventListener("transitionend",()=>{s.style.display="none"},{once:!0})}ne(),setTimeout(()=>{K()},300),we(),Le(),Ee(),N(),ce(),initializeMobileFilters();let a;window.addEventListener("resize",()=>{clearTimeout(a),a=setTimeout(()=>{N()},100)})});function ne(){document.querySelectorAll(".sort-option").forEach(t=>{t.addEventListener("click",()=>{document.querySelectorAll(".sort-option").forEach(n=>{n.classList.remove("bg-white/10","text-white"),n.classList.add("text-white/70")}),t.classList.remove("text-white/70"),t.classList.add("bg-white/10","text-white");const s=t.dataset.sort;localStorage.setItem("currentSort",s),x()})});const e=localStorage.getItem("currentSort");if(e){const t=document.querySelector(`.sort-option[data-sort="${e}"]`);t&&(t.classList.remove("text-white/70"),t.classList.add("bg-white/10","text-white"))}}let m=[],S="",w=null,p=1;const I={mobile:4,tablet:6,desktop:9,wide:15},E=document.getElementById("about-modal"),ae=document.getElementById("about-btn"),Z=document.getElementById("close-about"),k=document.getElementById("suggest-modal"),ie=document.getElementById("suggest-btn"),oe=document.getElementById("close-suggest"),M=24*60*60*1e3;document.getElementById("mobile-filters-btn");document.getElementById("mobile-filters-modal");document.getElementById("close-mobile-filters");document.getElementById("mobile-filters-content");document.getElementById("reset-filters");document.getElementById("apply-filters");const B=document.getElementById("active-filters-count"),re={tablet:768};function N(){var n;const e=document.getElementById("filters-sidebar"),t=(n=document.getElementById("mobile-filters-btn"))==null?void 0:n.parentElement;if(!e||!t)return;const s=window.innerWidth<re.tablet;e.classList.toggle("hidden",s),t.classList.toggle("hidden",!s)}function ce(){const e=document.getElementById("mobile-filters-btn"),t=document.getElementById("mobile-filters-modal"),s=t==null?void 0:t.querySelector(".flex.flex-col.bg-\\[\\#111\\]"),n=t==null?void 0:t.querySelector(".bg-\\[\\#0A0A0A\\]");if(!e||!t||!s||!n)return;function a(){t.classList.remove("hidden"),t.offsetHeight,n.classList.add("opacity-100"),s.classList.remove("translate-y-full"),document.body.classList.add("overflow-hidden")}function o(){n.classList.remove("opacity-100"),s.classList.add("translate-y-full"),setTimeout(()=>{t.classList.add("hidden"),document.body.classList.remove("overflow-hidden")},300)}e.addEventListener("click",c=>{c.preventDefault(),a()});const r=document.getElementById("close-mobile-filters");r&&r.addEventListener("click",c=>{c.preventDefault(),o()}),t.addEventListener("click",c=>{c.target===t&&o()}),document.addEventListener("keydown",c=>{c.key==="Escape"&&!t.classList.contains("hidden")&&o()});const i=document.getElementById("reset-filters");i&&i.addEventListener("click",c=>{c.preventDefault(),de(),Y()});const l=document.getElementById("apply-filters");l&&l.addEventListener("click",c=>{c.preventDefault(),o(),x()})}function Y(){const e=le();B&&(e>0?(B.textContent=`${e} active`,B.classList.remove("hidden")):B.classList.add("hidden"))}function le(){let e=0;return S&&e++,w&&e++,localStorage.getItem("currentSort")&&e++,e}function de(){S="",w=null,localStorage.removeItem("currentSort"),document.querySelectorAll(".status-filter-btn div").forEach(e=>{e.classList.remove("bg-black/40")}),document.querySelectorAll(".games-filter-btn div").forEach(e=>{e.classList.remove("border-emerald-500/20","bg-black/40"),e.classList.add("border-white/5","bg-black/20")}),document.querySelectorAll(".sort-option").forEach(e=>{e.classList.remove("bg-white/10","text-white"),e.classList.add("text-white/70")}),x()}async function K(){try{m=(await(await fetch("data/resources.json")).json()).sources,x(m),j(),ue().catch(()=>{console.log("Firebase stats loading failed, continuing with local data only")})}catch{}}async function ue(){try{const e=new Promise((o,r)=>setTimeout(()=>r(new Error("Firebase request timed out")),5e3)),t=H(O,"sources"),s=z(t),a=(await Promise.race([s,e])).val();if(a){m=m.map(o=>{var f;const r=o.url.replace(/[^a-zA-Z0-9]/g,"_"),i=((f=a[r])==null?void 0:f.stats)||{installs:0,copies:0,activity:[]},l=Array.isArray(i.activity)?i.activity:[],c=Date.now(),u=l.filter(y=>c-y<M).length;return{...o,stats:{...i,recentActivity:u,activity:l}}}),m.forEach(o=>{D(o.url,o.stats)});try{localStorage.setItem("sourceStats",JSON.stringify(a)),localStorage.setItem("statsLastUpdated",Date.now().toString())}catch{}return!0}return!1}catch{try{const t=localStorage.getItem("sourceStats");if(t){const s=JSON.parse(t);return m=m.map(n=>{var c;const a=n.url.replace(/[^a-zA-Z0-9]/g,"_"),o=((c=s[a])==null?void 0:c.stats)||{installs:0,copies:0,activity:[]},r=Array.isArray(o.activity)?o.activity:[],i=Date.now(),l=r.filter(u=>i-u<M).length;return{...n,stats:{...o,recentActivity:l,activity:r}}}),m.forEach(n=>{D(n.url,n.stats)}),console.log("Using cached stats from localStorage"),!0}}catch{}return m=m.map(t=>({...t,stats:{installs:0,copies:0,recentActivity:0,activity:[]}})),!1}}function U(e){document.querySelector("main").classList.add("blur-sm","transition-all","duration-200");const t=d.t.bind(d),s=document.createElement("div");s.className="fixed inset-0 flex items-center justify-center z-50 animate-fade-in p-4",s.innerHTML=`
    ...
    `,document.body.appendChild(s);const n=()=>{document.querySelector("main").classList.remove("blur-sm"),s.remove()};s.querySelector(".cancel-btn").addEventListener("click",()=>{n(),e(!1)}),s.querySelector(".proceed-btn").addEventListener("click",()=>{n(),e(!0)}),s.querySelector(".fixed.inset-0").addEventListener("click",a=>{a.target===a.currentTarget&&(n(),e(!1))})}function W(e){document.querySelector("main").classList.add("blur-sm","transition-all","duration-200");const t=d.t.bind(d),s=document.createElement("div");s.className="fixed inset-0 flex items-center justify-center z-50 animate-fade-in p-4",s.innerHTML=`
        <div class="fixed inset-0 bg-black/90 backdrop-blur-sm"></div>
        <div class="relative bg-[#111] rounded-xl overflow-hidden animate-scale-in max-w-md w-full mx-4">
            <!-- Animated background effects -->
            <div class="absolute inset-0 overflow-hidden">
                ...
                <div class="mt-2 pt-4 border-t border-white/5">
                    <div class="flex items-center justify-between text-white/40 text-xs">
                        <span class="flex items-center gap-1.5 mr-2">
                            ...
                            ${d.t("common.added")} ${ve(e.addedDate)}
                        </span>
                        <div class="source-stats flex items-center gap-3">
                            <span class="flex items-center gap-1.5 ${r>0?"text-red-400":""}
    ...
    `;const c=i.querySelector(".install-btn"),u=i.querySelector(".copy-btn");return u&&u.addEventListener("click",async()=>{const g=async()=>{await G(e.url,"copy")&&(navigator.clipboard.writeText(e.url),u.innerHTML='<i class="fas fa-check text-[10px]"></i> '+d.t("sourceCard.copied"),setTimeout(()=>{u.innerHTML='<i class="fas fa-copy text-[10px]"></i> '+d.t("sourceCard.copy")},2e3))},L=e.title==="CPGRepacks";a||L?(L?W:U)(C=>{C&&g()}):g()}),c&&c.addEventListener("click",async()=>{const g=async()=>{V(c,"loading");const b=await G(e.url,"install");if(V(c,b?"success":"rate-limited"),b){const C=encodeURIComponent(e.url);window.location.href=`hydralauncher://install-source?urls=${C}`}},L=e.title==="CPGRepacks";e.status.includes("Use At Your Own Risk")||L?(L?W:U)(C=>{C&&g()}):g()}),D(e.url,e.stats),i.dataset.copies=o.copies||0,i.dataset.installs=o.installs||0,i.dataset.activity=r,i}let $="wide";function Q(){const e=window.innerWidth;return e>=1536?"wide":e>=1024?"desktop":e>=640?"tablet":"mobile"}let _;window.addEventListener("resize",()=>{clearTimeout(_),_=setTimeout(()=>{N();const e=Q();if($!==e){const s=R(),n=T(),a=Math.ceil(s.length/n);if($==="wide"&&e==="desktop"){const o=(p-1)*I.desktop;p=Math.floor(o/I.desktop)+1}$=e,p=Math.min(Math.max(1,p),a),x(s),n<T()&&window.scrollTo({top:0,behavior:"smooth"})}},100)});function ge(e,t){return[...e].sort((s,n)=>{var a,o,r,i,l,c;switch(t){case"hot":const u=((a=s.stats)==null?void 0:a.recentActivity)||0;return(((o=n.stats)==null?void 0:o.recentActivity)||0)-u;case"new":return new Date(n.addedDate)-new Date(s.addedDate);case"most-copies":const y=((r=s.stats)==null?void 0:r.copies)||0;return(((i=n.stats)==null?void 0:i.copies)||0)-y;case"most-installs":const v=((l=s.stats)==null?void 0:l.installs)||0;return(((c=n.stats)==null?void 0:c.installs)||0)-v;case"name-asc":return s.title.localeCompare(n.title);case"name-desc":return n.title.localeCompare(s.title);default:return 0}})}function x(e=null){const t=document.getElementById("sources-container");if(!t)return;t.innerHTML="";let s=e||R();const n=localStorage.getItem("currentSort");n&&(s=ge(s,n)),console.log("Displaying sources with stats:",s),$=Q();const a=T(),o=Math.ceil(s.length/a);p=Math.min(Math.max(1,p),o);const r=(p-1)*a,i=Math.min(r+a,s.length);s.slice(r,i).forEach(c=>{const u=me(c);t.appendChild(u)}),fe(o),d.updatePageContent()}function T(){const e=window.innerWidth;return e>=2560?I.wide:e>=1024?I.desktop:e>=640?I.tablet:I.mobile}function fe(e){const t=document.getElementById("pagination");if(!t)return;let s="";s+=`
    ...
    `,t.innerHTML=s}window.changePage=function(e){if(e<1)return;const t=R(),s=Math.ceil(t.length/T());e>s||(p=e,x(t),window.scrollTo({top:0,behavior:"smooth"}))};document.querySelectorAll(".status-filter-btn").forEach(e=>{e.addEventListener("click",()=>{const t=e.dataset.status;document.querySelectorAll(".status-filter-btn").forEach(s=>{s.querySelector("div").classList.remove("bg-black/40")}),S===t?S="":(S=t,e.querySelector("div").classList.add("bg-black/40")),p=1,x(),j(),dispatchFiltersChanged()})});document.querySelectorAll(".games-filter-btn").forEach(e=>{e.addEventListener("click",()=>{const t=parseInt(e.dataset.min),s=parseInt(e.dataset.max);if(document.querySelectorAll(".games-filter-btn div").forEach(n=>{n.classList.remove("border-emerald-500/20","bg-black/40"),n.classList.add("border-white/5","bg-black/20")}),w&&w.min===t&&w.max===s)w=null;else{w={min:t,max:s};const n=e.querySelector("div");n.classList.remove("border-white/5","bg-black/20"),n.classList.add("border-emerald-500/20","bg-black/40")}p=1,x(),j(),Y(),dispatchFiltersChanged()})});function j(){const e={};m.forEach(t=>{t.status.forEach(s=>{e[s]=(e[s]||0)+1})}),document.querySelectorAll(".status-filter-btn").forEach(t=>{const s=t.dataset.status,n=t.querySelector(".text-white\\/40");n&&(n.textContent=e[s]||0)}),document.querySelectorAll(".games-filter-btn").forEach(t=>{const s=parseInt(t.dataset.min),n=parseInt(t.dataset.max),a=m.filter(i=>{const l=parseInt(i.gamesCount);return l>=s&&l<=n}).length,o=t.querySelector(".text-white\\/40");o&&(o.textContent=a);const r=t.querySelector(".bg-emerald-500\\/50");if(r){const i=Math.max(...Array.from(document.querySelectorAll(".games-filter-btn")).map(c=>{const u=parseInt(c.dataset.min),f=parseInt(c.dataset.max);return m.filter(y=>{const h=parseInt(y.gamesCount);return h>=u&&h<=f}).length})),l=i>0?a/i*100:0;r.style.width=`${l}%`}})}let A="";document.getElementById("search").addEventListener("input",e=>{A=e.target.value.toLowerCase(),p=1,x()});function R(){return m.filter(e=>{const t=!A||e.title.toLowerCase().includes(A)||e.description.toLowerCase().includes(A)||e.url.toLowerCase().includes(A),s=!S||e.status.includes(S),n=parseInt(e.gamesCount),a=!w||n>=w.min&&n<=w.max;return t&&s&&a})}const X=document.getElementById("sort-dropdown-btn"),q=document.getElementById("sort-dropdown"),pe=document.getElementById("current-sort");X.addEventListener("click",()=>{q.classList.toggle("hidden")});document.addEventListener("click",e=>{!X.contains(e.target)&&!q.contains(e.target)&&q.classList.add("hidden")});document.querySelectorAll(".sort-option").forEach(e=>{e.addEventListener("click",()=>{const t=e.dataset.sort;switch(pe.textContent=e.textContent.trim(),q.classList.add("hidden"),t){case"high-to-low":sortGamesFilters(!1);break;case"low-to-high":sortGamesFilters(!0);break;case"most-sources":he();break;case"most-popular":ye();break}})});function he(){const e=document.querySelector(".games-filter-btn").parentNode,t=Array.from(e.querySelectorAll(".games-filter-btn"));t.sort((s,n)=>{const a=parseInt(s.querySelector(".text-white\\/40").textContent);return parseInt(n.querySelector(".text-white\\/40").textContent)-a}),t.forEach(s=>s.remove()),t.forEach(s=>e.appendChild(s))}function ye(){const e=JSON.parse(localStorage.getItem("sourceStats")||"{}"),t=document.querySelector(".games-filter-btn").parentNode,s=Array.from(t.querySelectorAll(".games-filter-btn"));s.sort((n,a)=>{var f,y;const o=((f=m.find(h=>h.gamesCount===n.dataset.min))==null?void 0:f.url)||"",r=((y=m.find(h=>h.gamesCount===a.dataset.min))==null?void 0:y.url)||"",i=e[o]||{installs:0,copies:0},l=e[r]||{installs:0,copies:0},c=i.installs+i.copies;return l.installs+l.copies-c}),s.forEach(n=>n.remove()),s.forEach(n=>t.appendChild(n))}function ve(e){const t=new Date(e),n=Math.abs(new Date-t),a=Math.floor(n/(1e3*60*60*24)),o=d.t.bind(d);if(a===0)return o("common.date.today");if(a===1)return o("common.date.yesterday");if(a<30)return o("common.date.daysAgo",{days:a});{const r={year:"numeric",month:"short",day:"numeric"};return`${o("common.date.on")} ${t.toLocaleDateString(d.getCurrentLocale(),r)}`}}document.addEventListener("DOMContentLoaded",()=>{K(),sortGamesFilters(!1)});ae.addEventListener("click",()=>{E.classList.remove("hidden"),document.body.style.overflow="hidden"});Z.addEventListener("click",()=>{E.classList.add("hidden"),document.body.style.overflow=""});E.addEventListener("click",e=>{e.target===E&&Z.click()});document.addEventListener("keydown",e=>{e.key==="Escape"&&!E.classList.contains("hidden")&&(E.classList.add("hidden"),document.body.style.overflow="")});ie.addEventListener("click",()=>{k.classList.remove("hidden"),document.body.style.overflow="hidden"});oe.addEventListener("click",()=>{k.classList.add("hidden"),document.body.style.overflow=""});k.addEventListener("click",e=>{e.target===k&&(k.classList.add("hidden"),document.body.style.overflow="")});document.addEventListener("keydown",e=>{e.key==="Escape"&&(E.classList.contains("hidden")||(E.classList.add("hidden"),document.body.style.overflow=""),k.classList.contains("hidden")||(k.classList.add("hidden"),document.body.style.overflow=""))});function P(e,t,s){const n=new Date;n.setTime(n.getTime()+s*24*60*60*1e3),document.cookie=`${e}=${t};expires=${n.toUTCString()};path=/`}function ee(e){const t=e+"=",s=document.cookie.split(";");for(let n=0;n<s.length;n++){let a=s[n];for(;a.charAt(0)===" ";)a=a.substring(1,a.length);if(a.indexOf(t)===0)return a.substring(t.length,a.length)}return null}async function G(e,t){try{const s=e.replace(/[^a-zA-Z0-9]/g,"_"),n=`${t}_${s}`;if(ee(n))return!0;let a={installs:0,copies:0,activity:[],recentActivity:0};try{const r=new Promise((v,g)=>setTimeout(()=>g(new Error("Firebase request timed out")),3e3)),i=H(O,`sources/${s}/stats`),l=z(i),u=(await Promise.race([l,r])).val()||{installs:0,copies:0,activity:[]},f=Date.now(),h=(Array.isArray(u.activity)?u.activity:[]).filter(v=>f-v<M);h.push(f),a={installs:parseInt(u.installs||0)+(t==="install"?1:0),copies:parseInt(u.copies||0)+(t==="copy"?1:0),activity:h,recentActivity:h.length,lastUpdated:f},await Promise.race([J(i,a),new Promise((v,g)=>setTimeout(()=>g(new Error("Update timed out")),3e3))]);try{const v=localStorage.getItem("sourceStats");if(v){const g=JSON.parse(v);g[s]||(g[s]={}),g[s].stats=a,localStorage.setItem("sourceStats",JSON.stringify(g)),localStorage.setItem("statsLastUpdated",f.toString())}}catch{}}catch{console.log("Firebase update failed, continuing with local data");const i=m.find(l=>l.url===e);if(i&&i.stats){a={installs:parseInt(i.stats.installs||0)+(t==="install"?1:0),copies:parseInt(i.stats.copies||0)+(t==="copy"?1:0),activity:[],recentActivity:1,lastUpdated:Date.now()};try{const l=localStorage.getItem("sourceStats");if(l){const c=JSON.parse(l);c[s]||(c[s]={}),c[s].stats=a,localStorage.setItem("sourceStats",JSON.stringify(c)),localStorage.setItem("statsLastUpdated",Date.now().toString())}}catch{}}}P(n,"true",t==="install"?.003472222:347222e-9),D(e,a);const o=m.findIndex(r=>r.url===e);return o!==-1&&(m[o].stats=a),!0}catch{return!1}}function D(e,t=null){const s=document.querySelectorAll(".source-card"),n=Array.from(s).find(a=>a.dataset.url===e);if(n){const a=n.querySelector(".source-stats");if(a){const o=parseInt((t==null?void 0:t.installs)||0),r=parseInt((t==null?void 0:t.copies)||0),i=parseInt((t==null?void 0:t.recentActivity)||0);a.innerHTML=`
            ...
            `}n.dataset.copies=(t==null?void 0:t.copies)||0,n.dataset.installs=(t==null?void 0:t.installs)||0,n.dataset.activity=(t==null?void 0:t.recentActivity)||0}}function V(e,t){const s=e.innerHTML;switch(t){case"loading":e.disabled=!0,e.innerHTML=`
